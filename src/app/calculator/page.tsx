...
const translations = {
  th: {
    forgeChances: "โอกาสในการรังสรรค์ไอเทม ✨",
    selectOres: "เลือกสินแร่ที่ต้องการใช้งาน 💎",
    multiplier: "ค่าตัวคูณ 📈",
    predictedItem: "รายการไอเทมที่คาดว่าจะได้รับ 🛡️",
    activeTraits: "คุณสมบัติที่ได้ ⭐",
    weapon: "อาวุธ ⚔️",
    armor: "ชุดเกราะ 🛡️",
    clear: "ล้างข้อมูลทั้งหมด 🗑️",
    searchOres: "ค้นหาสินแร่... 🔎",
    empty: "ว่างเปล่า ⬜",
    damage: "ค่าความเสียหาย (Damage) 💥",
    defense: "ค่าการป้องกัน (Defense) 🛡️",
    price: "ราคา / มูลค่า 💰",
